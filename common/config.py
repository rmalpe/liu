...
data_connector: DataConnectorType = DataConnectorType[os.getenv("DATA_CONNECTOR", "angel")]  # type: ignore
...
# Broker
#
broker: BrokerType = BrokerType[os.getenv("LIU_BROKER", "angel")]
