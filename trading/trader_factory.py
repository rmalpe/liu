...
from liualgotrader.trading.angel import AngelTrader
...
def trader_factory(*args, **kwargs) -> Trader:
    ...
    elif config.broker == BrokerType.angel:
        if "ANGEL" not in traders:
            traders["ANGEL"] = AngelTrader(*args, **kwargs)
        return traders["ANGEL"]
    else:
